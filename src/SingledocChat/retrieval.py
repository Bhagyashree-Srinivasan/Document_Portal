...
class ConversationalRAG:
    ...
    def invoke(self, user_input: str) -> str:
        try:
            ...
            if not answer:
                self.log.warning("Empty answer received from RAG chain", session_id = self.session_id)
            self.log.info("RAG chain invoked successfully", session_id = self.session_id, 
